...
RegisterNetEvent('qb-phone:client:CloseNUI')
AddEventHandler('qb-phone:client:CloseNUI', function()
...
AddEventHandler('qb-phone:client:addPoliceAlert', function(alertData)
    PlayerJob = QBCore.Functions.GetPlayerData().job
    if PlayerJob.name == 'police' or PlayerJob.name == "bcso" and PlayerJob.onduty then
        SendNUIMessage({
...
-- // JOB CENTRE STUFF \\ --
RegisterNUICallback('ApplyJob1', function()
    -- Set Job 1 Code
